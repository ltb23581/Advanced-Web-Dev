class Overworld {
  ...
  init() {
    ...
    this.map.startCutscene([
      ...
      { type: "textMessage", text: "Also, as a side note..." },
      { type: "textMessage", text: "If you want fast animations, view this on a large display." },
      { type: "textMessage", text: "If you want a more ideal animation speed, view on a display like a laptop!" },
      { type: "textMessage", text: "(I will be fixing the animation consistency later)" },
