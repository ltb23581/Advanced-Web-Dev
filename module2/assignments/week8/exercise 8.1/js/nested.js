...
// document.querySelector('#asteroid').innerHTML = asteroid.is_potentially_hazardous_asteroid;
// document.querySelector('#asteroid').innerHTML = "Potentially Hazardous: " + asteroid.is_potentially_hazardous_asteroid;

// document.querySelector('#asteroid').innerHTML = asteroid.close_approach_data;
// document.querySelector('#asteroid').innerHTML = "Miss Distance (miles): " + asteroid.close_approach_data[0].miss_distance.miles;
// document.querySelector('#asteroid').innerHTML += "<br>Close Approach Date: " + asteroid.close_approach_data[0].close_approach_date;
// document.querySelector('#asteroid').innerHTML += "<br>Orbiting Body: " + asteroid.close_approach_data[0].orbiting_body;

document.querySelector('#asteroid').innerHTML = 
    "The asteroid named " + asteroid.name + 
    " is between " + asteroid.estimated_diameter.miles.estimated_diameter_min + 
    " and " + asteroid.estimated_diameter.miles.estimated_diameter_max + 
